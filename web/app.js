...
const T = {
  fr: {
    ...
    pid_warning: "N'inscrivez pas le nom complet ni d'autres renseignements identifiants. Rien n'est enregistré tant que vous n'enregistrez pas explicitement une session. Le nom du clinicien apparaît dans l'en-tête du rapport.",
    ...
    series_t1: "Temps 1", series_t2: "Temps 2",
  ...
  en: {
    ...
    pid_warning: "Do not enter the full name or other identifying information. Nothing is saved unless you explicitly save a session. The clinician name appears in the report header.",
    ...
    series_t1: "Time 1", series_t2: "Time 2",
